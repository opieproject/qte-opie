/****************************************************************************
** $Id: qt/src/xml/qxml.cpp   2.3.10   edited 2005-01-24 $
**
...
void qt_QXmlAttributes_clear( QXmlAttributes& attrs )
{
    attrs.clear();
}

void qt_QXmlAttributes_append( QXmlAttributes& attrs, const QString &qName, const QString &uri, const QString &localPart, const QString &value )
{
    attrs.append( qName, uri, localPart, value );
}
