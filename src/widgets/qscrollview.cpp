/****************************************************************************
** $Id: qt/src/widgets/qscrollview.cpp   2.3.10   edited 2005-01-24 $
**
...
#ifdef QT_KEYPAD_MODE
      else if ( qt_modalEditingEnabled && obj == this && (e->type() == QEvent::EnterModalEdit || e->type() == QEvent::LeaveModalEdit) ) {
	if ( inherits("QListBox") || inherits("QTextView") )
	    d->viewport.update();
    }
#endif
